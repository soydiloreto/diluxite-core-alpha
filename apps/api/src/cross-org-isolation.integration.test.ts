...
const PROBES: Probe[] = [
  ...
  { route: '/api/organizations/:orgId/github (GET)', method: 'GET', url: (c) => `/api/organizations/${c.orgA}/github` },
  { route: '/api/organizations/:orgId/github (DELETE)', method: 'DELETE', url: (c) => `/api/organizations/${c.orgA}/github` },
  { route: '/api/organizations/:orgId/github/sync (POST)', method: 'POST', url: (c) => `/api/organizations/${c.orgA}/github/sync`, payload: () => ({}) },
  { route: '/api/organizations/:orgId/resolver-allowlist (GET)', method: 'GET', url: (c) => `/api/organizations/${c.orgA}/resolver-allowlist` },
  ...
  { route: '/api/organizations/:orgId/generation-config/test (POST)', method: 'POST', url: (c) => `/api/organizations/${c.orgA}/generation-config/test`, payload: () => ({}) },
